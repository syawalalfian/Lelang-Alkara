...
@section('content')
<div class="card mb-4">
 <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4 col-md-12">
            <h1 class="h3 mb-0 text-gray-800">Data Barang</h1>
            <div class="ml-auto">
            <a href="{{route('cetakpdf')}}" class="btn btn-success ">
                <i class="fa fa-plus md-2 pr-1" aria-hidden="true"></i>Cetak PDF
             </a>
          </div>
          </div>
